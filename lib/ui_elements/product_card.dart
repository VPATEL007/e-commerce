...
class ProductCard extends StatefulWidget {
  ...
  ProductCard({Key key,this.identifier, this.id, this.image, this.name, this.main_price,this.stroked_price,this.has_discount,this.discount}) : super(key: key);
    ...
    return InkWell(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          return widget.identifier == 'auction'?  AuctionProductsDetails(id: widget.id): ProductDetails(id: widget.id,);
        }));
      },
      child: Container(
