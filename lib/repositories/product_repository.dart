...
class ProductRepository {
  Future<ProductMiniResponse> getFeaturedProducts({page = 0}) async {
    print('Page==${page}');
    Uri url = Uri.parse("${AppConfig.BASE_URL}/products/featured?page=${page}");
    print('Festured Product==${url}');
    ...
    print('Festured Response====${response.body}');
  ...
  Future<ProductMiniResponse> getFilteredProducts(
    ...
    print('ALl Product===${url.toString()}');
    final response = await http.get(url, headers: {
      "App-Language": app_language.$,
      "Currency-Code": SystemConfig.systemCurrency.code,
      "Currency-Exchange-Rate":
    ...
    print('ALl Product Response====${response.body}');
    return productMiniResponseFromJson(response.body);
  }
  ...
  Future<ProductMiniResponse> getDigitalProducts({
    ...
    print('Digital Product URL==${url.toString()}');
    ...
    print('Digital Response===${response.body}');
    return productMiniResponseFromJson(response.body);
  }
