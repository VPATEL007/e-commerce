                ...
                child: InkWell(
                    onTap: () {
                      if(double.parse(price.toString())<=0){
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>Checkout(title: "Purchase Package",rechargeAmount: double.parse(price.toString()),paymentFor: PaymentFor.PackagePay,packageId: package_id,)));
                      }
                    },
                    radius: 3.0,
                    child: Text(
